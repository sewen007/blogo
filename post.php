    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row tm-blog-post-row">
                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-blog-post-margin-b tm-blog-post-box-container">
                        ...
                        <div class="tm-blog-post-text-box-outer">
                            <div class="tm-blog-post-text-box">
                                ...
                                <p class="tm-blog-post-description" style="font-size: 15px;">
                                        <span class="" style="font-size:2.5em"><?php echo $content[0]; ?></span><?php echo trim( implode(' ', $content), $content[0]); ?></p>                       
                            </div>
                            <a href="post.php" class="tm-blog-post-link">Read More...</a>
                        </div>                                                

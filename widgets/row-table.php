    ...
    <table class="m-datatable__table" style="display: block; min-height: 300px; overflow-x: auto;">
        ...
        <tbody class="m-datatable__body" style="">
            ...
            foreach ($allRecords as $record) {
                $allProducts = $account->getAllProductsByPaymentID($record['payment_id']);
                $position = $count % 2;
            ...
            <tr data-row="0" class="m-datatable__row" style="left: 0px;">
                ...
                <td data-field="Latitude" class="m-datatable__cell"><span style="width: 110px;"><?php echo $record['product_number']; ?> products</span></td>
                ...
                <td class="m-datatable__detail" colspan="14">
                    <table>
                        ...
                        <tr class="m-datatable__row">
                            <td class="m-datatable__cell"><span style="width: 110px;">Product</span></td>
                            <td data-field="Notes" class="m-datatable__cell" style=""><span style="width: 350px;"><?php echo $product['name']; ?></span></td>
                        </tr>
                        <tr class="m-datatable__row">
                            <td class="m-datatable__cell"><span style="width: 110px;">Quantity</span></td>
                            <td data-field="Department" class="m-datatable__cell" style=""><span style="width: 180px;"><?php echo $product['quantity']; ?></span></td>
                        </tr>
                        <tr class="m-datatable__row">
                            <td class="m-datatable__cell"><span style="width: 110px;">Unit Price</span></td>
                            <td data-field="Website" class="m-datatable__cell" style=""><span style="width: 180px;">NGN <?php echo number_format($product['unit_price'], 2); ?></span></td>
                        </tr>
                        <tr class="m-datatable__row m-separator m-separator--dashed m-separator--lg">
                            <td class="m-datatable__cell"><span style="width: 110px;">Amount</span></td>
                            <td data-field="Website" class="m-datatable__cell" style=""><span style="width: 180px;">NGN <?php echo number_format($product['total'], 2); ?></span></td>
                        </tr>
                        <?php
                        }
                        ?>
                        ...
                        <tr class="m-datatable__row">
                            ...
                            <td data-field="TotalPayment" class="m-datatable__cell" style=""><a href="edit-payment?payment-id=<?php echo $record['payment_id']; ?>" >Edit Entry</a></td>
                        </tr>
                        <tr class="m-datatable__row">
                            ...
                            <td data-field="Status" class="m-datatable__cell" style="">
                                ...
                                <p style="display: none"><?php echo $record['payment_id']; ?></p>
                            </td>
                        </tr>
<!--                        <tr class="m-datatable__row">
...
<!--                        <tr class="m-datatable__row">
    ...
    <div class="m-datatable__pager m-datatable--paging-loaded clearfix">
        ...
        <div class="m-datatable__pager-info">
            ...
            </div><span class="m-datatable__pager-detail">Displaying 1 - 10 of 350 records</span></div>
    </div>
</div>
<!--end: Datatable -->